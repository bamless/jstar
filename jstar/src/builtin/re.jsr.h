...
"    end\n"
"    fun _format(match, variable)\n"
"        var variables = this._variables\n"
"        return ##variables[variable] if variables.contains(variable) else match\n"
"    end\n"
"    fun __rmod__(format)\n"
"        if !(format is String) then \n"
"            raise TypeException(\"Cannot format a \" + type(format).getName())\n"
"        end\n"
"        return gsub(format, \"(${(%w+)})\", this._format)\n"
"    end\n"
"end\n"
;